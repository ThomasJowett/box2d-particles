...
public:
	...
	/// -1 is returned unless SetDestructionByAge() is used to enable 
	/// the destruction of the oldest particles in the system.
...
private:
	...
	public:
		...
		/// Get index of the next particle. Returns -1 if
	...
	size_t LifetimeToExpirationTime(const float lifetime) const;
