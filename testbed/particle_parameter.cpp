...
const uint32 ParticleParameter::k_particleTypesCount =
	sizeof(ParticleParameter::k_particleTypes) / sizeof(ParticleParameter::k_particleTypes);
...
void ParticleParameter::Reset()
{
	...
	m_index = 0;
	SetDefinition(k_defaultDefinition, sizeof(k_defaultDefinition)/ sizeof(k_defaultDefinition[0]));
	Set(0);
}
