...
public:
	MultipleParticleSystems()
	{
		...
		for (uint32 i = 0; i < sizeof(m_emitters) / sizeof(m_emitters[0]); ++i)
		{
...
static int testIndex = RegisterTest("Particles", "Multiple Particle Systems", MultipleParticleSystems::Create);
